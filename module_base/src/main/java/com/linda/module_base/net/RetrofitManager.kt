...
import com.linda.module_base.utils.DeviceUtil
import com.linda.module_base.utils.DisplayUtil
import com.linda.module_base.utils.NetworkUtil
...
object RetrofitManager {
    ...
    private fun addQueryParameterInterceptor(): Interceptor {
        return Interceptor { chain ->
            ...
            val modifiedUrl = originalRequest.url.newBuilder()
                ...
                .addQueryParameter("size", DisplayUtil.getScreenRatio(BaseApplication.getContext()))
    ...
    private fun getOkHttpClient(): OkHttpClient {
        ...
        //设置 请求的缓存的大小跟位置
//        val cacheFile = File(BaseApplication.getContext().cacheDir, "cache")
